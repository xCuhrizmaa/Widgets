...
const priceCache = {};
const priceCacheTTL = 15000; // 15s for live P&L
...
// ── PRICE LOOKUP (crypto or stock, for paper trading) ──
...
// Map common ticker labels to CoinGecko IDs
const cryptoMap = {
...
console.log(“CoinGecko price lookup failed:”, e.message);
}
}

// Try as stock via Yahoo Finance
...
console.log(“Yahoo stock lookup failed:”, e.message);
}

// Fallback: try Yahoo v7 quote
try {
const r = await fetch(
...
console.log(“Yahoo v7 lookup failed:”, e.message);
}
